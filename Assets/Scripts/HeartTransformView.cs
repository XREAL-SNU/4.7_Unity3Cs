...
public class HeartTransformView : MonoBehaviourPun, IPunObservable
{
    ...
    {
        var tr = transform;
        PV.RPC("DOT", RpcTarget.AllBuffered);
    ...
    [PunRPC] void DOT()
    {
        //transform.DOMoveY(3f,3f,false);
        transform.DOShakePosition(3f,2f, 2, 2f);// 격렬하게 흔들리는구만..
    }
    ...
    public void OnPhotonInstantiate(PhotonMessageInfo info)
    {
        ...
        Debug.Log($"하트 {info.Sender.ActorNumber}'s ActorNumber임, t={info.SentServerTime}");
    }
}
